...
def merge_data(data_file_location):
    ...
    return
files = ['1004--local.json', '17--18.json', '18--19.json' , '19--20.json','20--21.json'
,'21--22.json'
,'22--23.json'
,'23--24.json'
,'24--25.json'
